...
public class EventConsumer implements CommunityConstant {
    ...
    @KafkaListener(topics = {TOPIC_COMMENT,TOPIC_LIKE,TOPCI_FOLLOW})
    ...
    public void handleShareMessage(ConsumerRecord record){
        ...
        String cmd = imagecmd + " --quality 75 " + htmlUrl + " " + wkImageStorage + "/" + fileName + suffix;
        try {
